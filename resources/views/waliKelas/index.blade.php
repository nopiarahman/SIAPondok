...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h3 class="my-3 align-center">Data Santri Kelas {{$cekwaliKelas->kelas->namaKelas}} Marhalah {{jenjangLengkap()}} </h3>
            @if (session('status'))
    ...
    <div class="card px-3 mb-n1  bg-light">
        <div class="row">
            ...
            {{-- <div class="col-md-8">
                <form method="GET" action="{{ url('/santriwustha') }}" accept-charset="UTF-8"
                        ...
                        <div class="box-tools">
                            <div class="has-feedback">
                                ...
                                <span class="input-group-btn ">
                                    ...
                                    <a href="{{ url('/santriwustha') }}" class="btn btn-primary mt-3 mb-n2" title="">
                                        Refresh Data </a>
                                </span>
                            </div>
                        </div>
    ...
    <div class="card mt-2">
        <div class="body table-responsive">
            <table class="table table-hover" id="table">
                ...
                <tbody>
                    @foreach ($santriKelas as $sw)
                    <tr>
                        <th scope="row">{{$loop->iteration}}</th>
                        <td>{{$sw->namaLengkap}}</td>
                        <td>{{$sw->namaWali}}</td>
                        <td><a href="santriwustha/{{$sw->id}}" class="btn btn-success"
                                style="border-radius: 5px ; margin:-5px ; font-size:12px">detail</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
