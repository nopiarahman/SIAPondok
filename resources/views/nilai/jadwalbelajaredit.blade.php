...
@section('container')        {{-- mengisi yield container dengan lebih dari 1 baris code --}}
          ...
          <h3 class="my-3 align-center">Edit Jadwal Belajar </h3>
          <form method="POST" action="/jadwalbelajar/{{$jadwalbelajar->id}}" class="pb-5" enctype="multipart/form-data">
              @method('patch')
                @csrf
                <div class="col-md-12">
                <div class="card p-4 bg-light">
                    <div class=" form-group row">
                      ...
                      <div class="col-md-6">
                        <input type="text"  class="form-control" id="namaLengkapas" name="" value="{{$jadwalbelajar->asatidzah->namaLengkap}}">
                        <input type="hidden"  class="form-control" id="idas" name="asatidzah_id" value="{{$jadwalbelajar->asatidzah_id}}">
                      </div>
                    </div>
                    <div class=" form-group row">
                      ...
                      <div class="col-md-6">
                        <input type="text"  class="form-control" id="namaMapel" name="" value="{{$jadwalbelajar->mapel->namaMapel}}">
                        <input type="hidden"  class="form-control" id="idMapel" name="mapel_id" value="{{$jadwalbelajar->mapel_id}}">
                      </div>
                    </div>
                    <div class=" form-group row">
                      ...
                      <div class="col-md-6">
                        <input type="text"  class="form-control" id="namaKelas" name="" value="{{$jadwalbelajar->kelas->namaKelas}}">
                        <input type="hidden"  class="form-control" id="idKelas" name="kelas_id" value="{{$jadwalbelajar->kelas_id}}">
                      </div>
                    </div>
                    <div class=" form-group row">
                      ...
                      <div class="col-md-8">
                        <select class="form-control show-tick" tabindex="-98" name="hari">
                          <option name="hari" @if($jadwalbelajar->hari=='Senin')selected @endif value="Senin">Senin</option>
                          <option name="hari" @if($jadwalbelajar->hari=='Selasa')selected @endif value="Selasa">Selasa</option>
                          <option name="hari" @if($jadwalbelajar->hari=='Rabu')selected @endif value="Rabu">Rabu</option>
                          <option name="hari" @if($jadwalbelajar->hari=='Kamis')selected @endif value="Kamis">Kamis</option>
                          <option name="hari" @if($jadwalbelajar->hari=='Sabtu')selected @endif value="Sabtu">Sabtu</option>
                          <option name="hari" @if($jadwalbelajar->hari=='Ahad')selected @endif value="Ahad">Ahad</option>
                      </select></div>
                    </div>
                    <div class="form-group row">
                      <label for="jamMulai" class="col-sm-3 col-form-label">Jam Mulai</label>
                      <div class="col-sm-2 ">
                        <input type="time" class="timepicker form-control" name="jamMulai" placeholder="Please choose a time..." data-dtp="dtp_MQlmB" value="{{$jadwalbelajar->jamMulai}}">
                        {{-- <input type="date" class="form-control @error('jamMulai') is-invalid @enderror" id="jamMulai" name="jamMulai" value="{{$jadwalbelajar->jamMulai')}}"> --}}
                        @error('jamMulai')
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2 ">
                        <input type="time" class="timepicker form-control" name="jamSelesai" placeholder="Please choose a time..." data-dtp="dtp_MQlmB" value="{{$jadwalbelajar->jamSelesai}}">
                        {{-- <input type="date" class="form-control @error('jamSelesai') is-invalid @enderror" id="jamSelesai" name="jamSelesai" value="{{$jadwalbelajar->jamSelesai')}}"> --}}
                        @error('jamSelesai')
                          <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                      </div>  
                    </div>
                  <button type="submit" class="btn btn-primary align-center py-2 mb-2"> Edit Data</button>
