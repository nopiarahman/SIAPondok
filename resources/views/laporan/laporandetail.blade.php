      ...
      <div class="body table-responsive">
        <table class="table table-striped table-bordered align-center">
          ...
          <tbody>
            @if($nilaiaktif!=null)
            <tr>
            <th scope="col" colspan="10" class=" align-left px-3"><h5>I. Nilai Diniyah </h5></th>
          ...
          <tr>
          <th scope="col" colspan="10" class=" align-left px-3"><h5>II. Nilai Umum</h5></th>
        ...
        <tfoot>
          <tr>
            <td colspan="6"><p class="font-weight-bold align-right">Jumlah</p></td>
          <td><p class="font-weight-bold align-center">{{round($nilaiaktif->sum('rataRata'))}}</p></td>
          </tr>
          <tr >
            <td colspan="6"><p class="font-weight-bold align-right">Rata-rata</p></td>
            <td><p class="font-weight-bold align-center">{{round($nilaiaktif->avg('rataRata'),2)}}</p></td>
          </tr>
        </tfoot>
        @else
