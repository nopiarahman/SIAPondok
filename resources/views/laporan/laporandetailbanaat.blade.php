    ...
    <div class="body table-responsive">
        <table class="table table-striped table-bordered align-center">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="col" colspan="10" class=" align-center px-3">
                        <h5>NILAI TEORI </h5>
                    </th>
                </tr>
                <tr>
                ...
                @foreach ($nilaiDiniyahTeori as $nilai)
                <tr>
                ...
                <tr>
                    ...
                    @foreach ($nilaiBahasaTeori as $nilai)
                </tr>
                <tr>
                    <th scope="row">{{$loop->iteration}}</th>
                    <td>{{$nilai->mapel->namaMapel}}</td>
                ...
                @foreach ($nilaiDiniyahPraktek as $nilai)
                <tr>
                    <th scope="row">{{$loop->iteration}}</th>
                    <td>{{$nilai->mapel->namaMapel}}</td>
                    <td>{{$nilai->harian}}</td>
                ...
                <tr>
                    ...
                    @foreach ($nilaiBahasaPraktek as $nilai)
                </tr>
                <tr>
                    <th scope="row">{{$loop->iteration}}</th>
                    <td>{{$nilai->mapel->namaMapel}}</td>
